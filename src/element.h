...
enum ELEMENT_VALUE {
    ...
    ELEMENT_VALUE_DECIMAL = 110,    ELEMENT_VALUE_GESIMAL = 610, ELEMENT_VALUE_DECA = 10,
    ELEMENT_VALUE_ELEVENARY = 611,  ELEMENT_VALUE_LEVA = 11,
    ELEMENT_VALUE_DOZENAL = 612,    ELEMENT_VALUE_DOZA = 12,
    ELEMENT_VALUE_BAKERS_DOZENAL = 113, ELEMENT_VALUE_KERS_DOZENAL = 613, ELEMENT_VALUE_BAKER = 13,
